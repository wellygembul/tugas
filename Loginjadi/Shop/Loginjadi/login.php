...
<!--============================ Css Bootstrap ================================================-->
 <link href="css/bootstrap.css" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="fontawesome-free-5.7.2-web/css/fontawesome.min.css">
     ...
     <script type="jss/jquery.min.js" ></script>
     <link rel="stylesheet" type="text/css" href="styles.css">
</head>
<body style="background-image: url(images/bag2.jpg);background-size: cover; background-attachment: fixed;">
	
	
		
			<div class="p-l-85 p-r-85 p-t-55 p-b-55" style="width: 550px; margin-top: 15px;">
				<form class="login100-form validate-form flex-sb flex-w">
					<span class="login100-form-title p-b-29">
						<img src="images/user/L3.png" style="width: 150px;height: 150px; margin-top: -65px; margin-left: 27%;">
					</span>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" style="margin-top:-35px; margin-bottom: 20px;">
							Login
						</button>
					</div>
