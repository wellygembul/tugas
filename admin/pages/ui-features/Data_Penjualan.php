...
$no = mysqli_query($koneksi, "SELECT No From penjualan ORDER BY No DESC");
      ...
      <div class="main-panel">
        <div class="content-wrapper">
        	<div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><b>Form Tambah Data Barang</b></h4>
                  <form action="aksi.php" method="post" class="form-sample">
                    <div class="row">
	                      <div class="col-md-3">
	                        <div class="form-group row">
	                          <div class="col-sm-9">
	                            <input type="text" name="No" autocomplete="off" readonly="readnoly" value="<?php echo $No; ?>" class="form-control" />
	                          </div>
	                        </div>
	                      </div>
                          <div class="col-md-3">
                            <div class="form-group row">
                              <div class="col-sm-9">
                                <input type="text" name="Nama" autocomplete="off" class="form-control" placeholder="Nama Barang" />
                              </div>
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group row">
                              <div class="col-sm-9">
                                <input type="text" id="Tanggal" autocomplete="off" name="Tanggal" class="form-control" placeholder="dd/mm/yyyy" />
                              </div>
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group row">
                              <div class="col-sm-9">
                                <input type="text" name="Jumlah" autocomplete="off" class="form-control" placeholder="Jumlah Barang" />
                              </div>
                            </div>
                          </div>
                      </div>
          ...
          <div class="col-12 grid-margin">
            <div class="row">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title"><b>Tabel Data Barang</b></h2>
                        <table>
                          <tr>
                            ...
                            <td >
                              ...
                              <div class="col-md-4">
                                <a href="Verifikasi_Penjualan.php">
                                  <button type="button" class="btn btn-inverse-warning btn-fw" title="Menampilkan Data Berdasarkan Tanggal" >
                                    <i class="fas fa-calendar-week"></i>View
                                  </button>
                                </a>
                              </div>
                               <div class="col-md-4">
                                  <a href="Cetak.php">
                                    <button type="button" title="Cetak data" class="btn btn-inverse-primary btn-fw">
                                  <i class="fas fa-print"></i>Print
                                  </button>
                                  </a>
                                </div>
                                <div class="col-md-4">
                                  <button type="submit" title="Refresh" onclick="document.location.reload(true)" title="Cetak data" class="btn btn-inverse-info btn-fw">
