...
<h3 style="text-align: center; margin-bottom: 45px;">DATA LAPORAN BARANG MASUK DAN KELUAR</h3>
	<?php 
		include 'koneksi.php'
	 ?>
					<table style="width:80%; border-collapse: collapse; border: 1px solid black; margin: auto;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="border-collapse: collapse; border: 1px solid black; padding-left: 10px;"><?php echo $d['Status']; ?></td>
