          ...
          <div class="col-12 grid-margin">
            <div class="row">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h2 class="card-title"><b>Data Barang Masuk</b></h2>
                        <table>
                          <tr>
                              ...
                              <div class="col-md-2" style="margin-right: 5px;">
                                <a href="DBM.php">
                                  <button type="button" class="btn btn-icons btn-rounded btn-success">
                                    <i class="fas fa-plus" style="font-size: 13pt;"></i>
                                  </button>
                                </a>
                              </div>
                              <div class="col-md-2" style="margin-right: 5px;">
                                <a href="VerifikasiDBM.php">
                                  <button type="button" class="btn btn-icons btn-rounded btn-warning" title="Menampilkan Data Berdasarkan Tanggal" >
                                    <i class="fas fa-calendar-week" style="font-size: 13pt;"></i>
                                  </button>
                                </a>
                              </div>
                               <div class="col-md-2" style="margin-right: 5px;">
                                  <a href="CetakDBM.php">
                                    <button type="button" title="Cetak data" class="btn btn-icons btn-rounded btn-primary">
                                    <i class="mdi mdi-printer" style="font-size: 13pt;"></i>
                                  </button>
                                  </a>
                                </div>
                                <div class="col-md-2" style="margin-right: 5px;">
                                  <button type="button" onclick="document.location.reload(true)" title="Refresh" class="btn btn-icons btn-rounded btn-info">
                                    <i class="fas fa-sync" style="font-size: 13pt;"></i>
                                  </button>
                                </div>
