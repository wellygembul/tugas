...
$no = mysqli_query($koneksi, "SELECT No From barang ORDER BY No DESC");
        	...
        	<div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="aksiDBM.php" method="post" class="form-sample">
                    <div class="row">
	                      <div class="col-md-6">
                    ...
                    <div class="row">
                                ...
                                <div class="col-sm-4">
                                  <div class="form-check">
                                    <label class="form-check-label">
                                      <input type="checkbox" id="Check1" class="form-check-input" name="Status" value="Masuk"> Masuk
                                    </label>
                                  </div>
                                </div>
                                <div class="col-sm-5">
                                  <div class="form-check">
                                    <label class="form-check-label">
                                      <input type="checkbox" id="Check2" class="form-check-input" name="Status" value="Keluar"> Keluar
                                    </label>
                                  </div>
                                </div>
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <input type="text" id="Tanggal" name="Tanggal" autocomplete="off" class="form-control" placeholder="yy-mm-dd" />
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" name="Dari">
	                          ...
	                          <option value="PT Alfa">PT Alfa</option>
	                          <option value="PT Indo Midi Jaya">PT Indo Midi Jaya</option>
	                          <option value="PT Zara Kusuma">PT Zara Kusuma</option>
                            <option value="PT Nevalium Abadi">PT Nevalium Abadi</option>
                            <option value="PT Fladeo-Shoes">PT Fladeo-Shoes</option>
                            </select>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Harga per/pcs</label>
                          <div class="col-sm-9">
                    ...
                    <div class="col-lg-2">
                      ...
                      <div class="col-lg-2">
                        <a href="Barang_Masuk.php">
                         <input type="button" class="btn btn-outline-info btn-rounded btn-fw" value="Kembali"></input>
                        </a>
                      </div>
