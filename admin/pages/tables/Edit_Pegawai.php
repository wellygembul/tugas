                  ...
                  <?php 
                    ...
                    $No = $_GET['No'];
                     $query = "SELECT * FROM pegawai WHERE No='".$No."'";
                      ...
                      $d = mysqli_fetch_array($sql); // Ambil data dari hasil eksekusi $sql
                       # code...
                     
                   ?>
                  <form action="proses_edit.php" method="post" enctype="multipart/form-data" class="form-sample">
                      <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nama </label>
                          <div class="col-sm-9">
                            <input type="hidden" name="No" readonly="readnoly" value="<?php echo $No; ?>" class="form-control" />
                       ...
                       <div class="col-md-6">
                        <div class="form-group row" >
                          ...
                          <div class="row">
                            <div class="col-lg-3">
                              <div class="col-sm-9">
                                <img src="file/<?php echo $d['Foto']; ?>" width=90px; height=90px;>
                             </div>
                            </div>
                            <div class="col-lg-3">
                              <div class="col-sm-9">
                                <input type="file" name="Foto" style="margin-top: 50px;">
                             </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="Tempat" class="form-control" value="<?php echo $d['Tempat']; ?>"></input>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="date" name="Tanggal" class="form-control"  value="<?php echo $d['Tanggal']; ?>" placeholder="dd/mm/yyyy" />
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="col-sm-9">
                            <?php $Status= $d['Status']; ?>
                             <select class="form-control" name="Status">
                               <option value="Pilih" <?php echo ($Status == 'Pilih') ? "selected": "" ?>>-Pilih-</option>
                              <option value="Sudah Menikah" <?php echo ($Status == 'Sudah Menikah') ? "selected": "" ?>>Sudah Menikah</option>
                              <option value="Belum Menikah" <?php echo ($Status == 'Belum Menikah') ? "selected": "" ?>>Belum Menikah</option>
                            </select>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Pendidikan</label>
                            <div class="col-sm-9">
                             <?php $Pendidikan= $d['Pendidikan']; ?>
                                <select class="form-control" name="Pendidikan">
                                <option value="Pilih" <?php echo ($Pendidikan == 'Pilih') ? "selected": "" ?>>-Pilih-</option>
                                <option value="SMP/MTS" <?php echo ($Pendidikan == 'SMP/MTS') ? "selected": "" ?>>SMP/MTS</option>
                                <option value="SMA/SMK/MA" <?php echo ($Pendidikan == 'SMA/SMK/MA') ? "selected": "" ?>>SMA/SMK/MA</option>
                                <option value="Sarjana" <?php echo ($Pendidikan == 'Sarjana') ? "selected": "" ?>>Sarjana</option>
                              </select>
                            </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Jabatan</label>
                            <div class="col-sm-9">
                             <?php $Jabatan= $d['Jabatan']; ?>
                            <select class="form-control" name="Jabatan" >
                              <option value="Pilih" <?php echo ($Jabatan == 'Pilih') ? "selected": "" ?>>-Pilih-</option>
                              <option value="Karyawan Magang" <?php echo ($Jabatan == 'Karyawan Magang') ? "selected": "" ?>>Karyawan Magang</option>
                              <option value="Staf Pengiriman" <?php echo ($Jabatan == 'Staf Pengiriman') ? "selected": "" ?>>Staf Pengiriman</option>
                              <option value="Staf Gudang" <?php echo ($Jabatan == 'Staf Gudang') ? "selected": "" ?>>Staf Gudang</option>
                              </select>
                            </div>
                        </div>
                      </div>
                    ...
                    <div>
                     	<input type="button" onclick="apply()" class="btn btn-outline-primary btn-rounded btn-fw" value="Update"></input>
